...
class ImageUploader
{
  ...
  */
  ...
  public function checkImageType($image)
  {
     $typearr=array('image/jpg', 'image/png', 'image/jpeg');
     if(in_array($image, $typearr))
     {
        return true;
  ...
  { 
    ...
    // $result = move_uploaded_file($image["tmp_name"], "/uploads/images/".$image['name']);
